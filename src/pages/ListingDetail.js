...
const ListingDetail = () => {
    ...
    const { currentListing: currentListingData, loading, error } = useSelector((state) => state.listings);
    const currentListing = currentListingData || currentListingData;
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    >
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                            <img
                                src={currentListing.images?.[0] || '/placeholder-car.jpg'}
                    ...
                    >
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                            ...
                            <div className="flex items-center space-x-4 text-sm text-gray-600 mb-3">
                                ...
                                <div className="flex items-center space-x-1">
                                    ...
                                    <span>Listed {new Date(currentListing.created_at).toLocaleDateString()}</span>
                                </div>
                            </div>

                            <div className="flex items-center space-x-4">
                                <div className={`px-3 py-1 rounded-full text-xs font-semibold ${currentListing.availability === 'available'
                                        ? 'bg-green-100 text-green-800'
                                        : 'bg-red-100 text-red-800'
                                    }`}>
                                    {currentListing.availability === 'available' ? 'Available' : 'Sold'}
                                </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                            ...
                            <div className="flex items-center space-x-4 mb-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900">{currentListing.full_name}</h3>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                            <div className="flex space-x-4">
                                ...
                                >
                                    ...
                                    <span>
                                        {currentListing.availability === 'available' ? 'Contact Seller' : 'Not Available'}
                                    </span>
                                </button>
                                <button
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium capitalize">{currentListing.category}</p>
                                </div>
                                <div>
                                    <span className="text-gray-500">Listed On:</span>
                                    <p className="font-medium">{new Date(currentListing.created_at).toLocaleDateString()}</p>
                                </div>
                                <div>
                                    <span className="text-gray-500">Status:</span>
                                    <p className="font-medium capitalize">{currentListing.availability}</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
